...
local user = game:service('UserInputService');
...
corner.CornerRadius = UDim.new(0, 5) -- 5 pixels
corner.Parent = UiWindow
    ...
    Header.BackgroundColor3 = Color3.fromRGB(202, 40, 0)
